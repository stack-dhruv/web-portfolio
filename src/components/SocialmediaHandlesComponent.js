...
const SocialmediaHandlesComponent = () => {
    return (
        <ul class="ml-1 mt-8 flex items-center" aria-label="Social media">
            <li class="mr-5 text-xs">
                <a
                    class="block hover:text-slate-200"
                    href="https://github.com/stack-dhruv"
                    target="_blank"
                    rel="noreferrer"
                >
            ...
            <li class="mr-5 text-xs">
                <a
                    class="block hover:text-slate-200"
                    href="https://instagram.com/dhruv_1563_"
                    target="_blank"
                    rel="noreferrer"
                >
            ...
            <li class="mr-5 text-xs">
                <a
                    class="block hover:text-slate-200"
                    href="https://twitter.com/Dhruv1563"
                    target="_blank"
                    rel="noreferrer"
                >
...
export default SocialmediaHandlesComponent;
